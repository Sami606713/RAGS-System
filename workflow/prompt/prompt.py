...
- After that, provide a plain and detailed, step-by-step explanation with numbers, examples, and bullets. Keep it simple and consumer-friendly.
...
- Explanation(But donot show the heading only give the response) 
  explain in detail with step-by-step
  [Plain details explanation with numbers, bullets, and citations]
